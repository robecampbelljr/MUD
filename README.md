...
### Purpose
This is a "tutorial world". I will be following the [Evennia Beginner Tutorial]. I will be using this README's in the _Journal/_ folder for notes during the learning process as well as anecdotal experiences while following the tutorial.
